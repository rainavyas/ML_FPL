...
def create_tables():
    mydb = mysql.connector.connect(host='localhost',database='mysql',user='root',password="abc314")
...
def populate_tables(Name, Season, season_table):
    mydb = mysql.connector.connect(host='localhost',database='FPL',user='root',password="abc314")
    mycursor = mydb.cursor()
